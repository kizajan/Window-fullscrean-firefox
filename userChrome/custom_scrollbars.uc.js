...
/* ***********************************************************************************************
 ...
 [!] 每次變更後要刪除startupcache資料夾後重啟才會生效!
...
var custom_scrollbar_opacity = true; /* default = false */
var custom_opacity_value = "0.01"; /* default = 1.0 */
var custom_opacity_hover_value = "0.6"; /*游標移往時不透明度 */
var enable_floating_scrollbars = true; /* default = false // scrollbars on top of web content */

// Custom scrollbar appearance settings - "cs"
var enable_custom_scrollbars = true;
var cs_background_color = "#000000"; /* default = #CCCCCC */
var cs_background_image = "linear-gradient(to right,transparent,rgba(255,255,255,0.5),transparent)"; /* default = none */
var cs_thumb_color = "#888888"; /* default = #33CCFF */
var cs_thumb_image = "linear-gradient(to right,transparent,rgba(255,255,255,0.5),transparent)"; /* default = unset */
var cs_thumb_hover_color = "#338891"; /* default = #66FFFF */
...
var cs_thumb_border_color = "#338891"; /* default ##33CCFF */
var cs_buttons_color = "#888888"; /* default = #000000 */
var cs_buttons_image = "linear-gradient(to right,transparent,rgba(255,255,255,0.5),transparent)"; /* default = unset */
var cs_buttons_hover_color = "#338891"; /* default = #000066 */
...
var scrollbar_opacity = {
  ...
  var uri = Services.io.newURI("data:text/css;charset=utf-8," + encodeURIComponent('\
	...
	scrollbar:hover {\
	  opacity: '+custom_opacity_hover_value+' !important;\
	}\
	\
  '), null, null);
